        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              @endif
                {{-- @foreach ($expertisess as $expertises) --}}
              <form action="{{ route('expertises.update', $expertises->id) }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="title" value="{{ $expertises->title }}" id="title" placeholder="Titre de l'article">
                      </div>
                      <div class="form-group">
                        <label>Description </label>
                          <textarea id="compose-textarea" name="description" value="{{ $expertises->description }}"  class="form-control" style="height: 300px">
                      ...
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-6">
                          <img src="{{ asset('image-expertise/'.$expertises->image)}}" height="100" alt="" srcset="">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
