        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <form action="{{ route('partenaires.update', $partenaire->id) }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-6">
                          <img src="{{ asset('image-partenaire/'.$partenaire->image)}}" height="100" alt="" srcset="">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
