        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <form action="{{ route('comptes.update', $compte->id) }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="title" value="{{ $compte->title }}" id="title" placeholder="Nom du compte">
                      </div>
                      <div class="form-group">
                        <label for="numero">Numéro compte</label>
                        <input class="form-control" name="numero" value="{{ $compte->number }}" id="numero" placeholder="Numéro du compte">
                      </div>
                    </div>
                    <!-- /.card-body -->
