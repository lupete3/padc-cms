                          ...
                          <div class="card-blog" >
                            <div class="footer ">
                              <div class="entry-footer mt-4">
                                <h4 class="title-section">{{ $compte->number }} </h4> 
                                <h6 class="title-section">{{ $compte->title }} </h6> 
                              </div>
                              <span class="float-right mt-4"> <i class="mai-heart text-primary " style="font-size: 30px"></i></span>
                            </div>
                          </div>
                        </div>
                    @endforeach
