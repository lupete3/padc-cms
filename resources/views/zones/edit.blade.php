        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <form action="{{ route('zones.update', $zone->id) }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="title" value="{{ $zone->title }}" id="title" placeholder="Titre de l'article">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-6">
                          <img src="{{ asset('image-zone/'.$zone->image)}}" height="100" alt="" srcset="">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
