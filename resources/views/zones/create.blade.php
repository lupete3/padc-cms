        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              @endif
              <form action="{{ route('zones.store') }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('POST')
                @csrf
                <div class="card card-primary card-outline">
                    <div class="card-header">
                      <h3 class="card-title">Compléter les informations de la zone</h3>
                    </div>
                    <!-- /.card-header -->
                      <div class="card-body">
                        <div class="form-group">
                          <input class="form-control" name="title" value="{{ old('title') }}" id="title" placeholder="Nom de a zones">
                        </div>
                        <div class="form-group">
                          <label>Description de l'actualité</label>
                            <textarea id="compose-textarea" name="description" value="{{ old('description') }}"  class="form-control" style="height: 300px">
                              Description sur la zones d'intervention
                            </textarea>
                        </div>
                        <div class="form-group">
