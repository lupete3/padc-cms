        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <form action="{{ route('apropos.update', $apropo->id) }}" method="POST" id="form" enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h3 class="card-title">Compléter les informations de l'association</h3>
                  </div>
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="title" value="{{ $apropo->title }}" id="title" placeholder="Titre de l'article">
                      </div>
                      <div class="form-group">
                        <label>Description </label>
                          <textarea id="compose-textarea" name="description" value="{{ $apropo->apropos }}"  class="form-control" style="height: 300px">
                            {{ $apropo->apropos }}
                          </textarea>
                      </div>
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-6">
                          <img src="{{ asset('image-apropo/'.$apropo->image)}}" height="100" alt="" srcset="">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
