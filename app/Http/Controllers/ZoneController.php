...
class ZoneController extends Controller
{
    ...
    {
        $viewData = [];
        $viewData["title"] = "Liste des mission";
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('zones.create')->with('success', 'Mission ajoutée avec succès');
    }
    ...
    {
        $viewData = [];
        $viewData["title"] = "Modification mission";
    ...
    public function destroy(Zone $zone)
    {
        ...
        return redirect()->back()->with('success', 'Miission supprimée avec succès');
    }
}
